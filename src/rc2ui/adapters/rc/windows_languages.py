"""Standard Win32 language constants used by RC LANGUAGE declarations.

Kept in the RC adapter so source parsing does not depend on an installed SDK.
The values mirror the public LANG_* and SUBLANG_* constants from winnt.h.
"""
...
PRIMARY_LANGUAGES: dict[str, int] = {
    ...
    "LANG_DUTCH": 0x13,
    "LANG_ENGLISH": 0x09,
    # ReactOS extension used by its otherwise Win32-compatible resources.
    "LANG_ESPERANTO": 0x8f,
    "LANG_ESTONIAN": 0x25,
    "LANG_FAEROESE": 0x38,
    "LANG_FARSI": 0x29,
